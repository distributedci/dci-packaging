...
PATH_TO_PROJ=$1
PROJ_NAME=$2
SUPPORTED_DISTRIBUTIONS='fedora-24-x86_64 epel-7-x86_64'
...
#
repo_conf["fedora-24-x86_64"]='
[dci]
name=Distributed CI - Fedora
baseurl=https://packages.distributed-ci.io/repos/current/fedora/24/x86_64/
gpgcheck=1
...
baseurl=http://packages.distributed-ci.io/repos/development/fedora/24/x86_64/
gpgcheck=1
gpgkey=https://packages.distributed-ci.io/RPM-GPG-KEY-distributedci
enabled=1
...
baseurl=http://mirror.centos.org/centos/7/cloud/$base_arch/openstack-mitaka/
gpgcheck=1
enabled=1
gpgkey=https://raw.githubusercontent.com/openstack/puppet-openstack_extras/91fac8eab81d0ad071130887d72338a82c06a7f4/files/RPM-GPG-KEY-CentOS-SIG-Cloud
'
